...
def set_unexport_to_one():
    global glob_unexport    # Needed to modify global copy of globvar
    glob_unexport = 1
...
def print_glob_unexport():
    print(glob_unexport)     # No need for global declaration to read value of globvar



def set_direction_to_one():
    global glob_direction    # Needed to modify global copy of globvar
    glob_direction = 1
...
def print_glob_direction():
    print(glob_direction)     # No need for global declaration to read value of globvar
...
def print_glob_value():
    print(glob_value)     # No need for global declaration to read value of globvar
...
def set_edge_to_one():
    global glob_edge  # Needed to modify global copy of globvar
    glob_edge = 1
...
def print_glob_edge():
    print(glob_edge)  # No need for global declaration to read value of globvar
...
class Operations(pyfuse3.Operations):
    ...
    def _add_path(self, inode, path):
        ...
        print_glob_lastpath()  # Prints 0

        last_path=glob_lastpath
        print(last_path)
...
##########################################################################################
    ...
    async def write(self, fd, offset, buf):
        ...
        export = glob_export
        unexport = glob_unexport
        direction = glob_direction
        value = glob_value
        active = glob_active
        edge = glob_edge
        last_path = glob_lastpath
...
if __name__ == '__main__':
    ...
    set_export_to_zero()
    print_glob_export()  # Prints 0

    set_unexport_to_zero()
    print_glob_unexport()  # Prints 0

    set_direction_to_zero()
    print_glob_direction()  # Prints 0

    set_value_to_zero()
    print_glob_value()  # Prints 0

    set_active_to_zero()
    print_glob_active()  # Prints 0

    set_edge_to_zero()
    print_glob_edge()  # Prints 0
